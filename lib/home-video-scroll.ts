 ...
 *   clean final perspective, no distorted zoom-out). Ultralight v2 chosen
 *   (SSIM 0.98 vs light v2, −36% weight). Rollback for dusk = restore
 *   `dusk-mobile-scroll-light.mp4`.
 */
export const HOME_VIDEO_SCROLL = {
  ...
  dusk: "/videos/dusk-mobile-scroll-ultralight-v2.mp4",
} as const;
